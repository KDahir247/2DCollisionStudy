...
#include "StaticIntersection.h"
Point2D Collision::LineLineIntersection(const Line2D &A, const Line2D& B) {
    Point2D IA, IB;
...
Point2D Collision::LineHLineIntersection(const Line2D& A, const HLine2D& B) {
    float t{};
    Point2D I(0,0);
...
Point2D Collision::LineVLineIntersection(const Line2D& A, const VLine2D& B) {
    float t{};
    Point2D I{};
